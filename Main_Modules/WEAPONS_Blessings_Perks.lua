...
--[+ ++WEAPON - PERKS - 武器专长++ +]--
	--[+ MELEE - 近戰武器 - 近战武器 +]--
		...
		["loc_trait_melee_common_wield_increased_armored_damage_desc"] = { -- damage: +25%
			...
			["zh-tw"] = "對防彈護甲敵人的"..CKWord("傷害", "Damage_rgb_tw").."提升 "..CNumb("{damage:%s}", "dmg_var_rgb"),
		...
		["loc_trait_melee_common_wield_increased_berserker_damage_desc"] = { -- damage: +25%
			...
			["zh-tw"] = "對狂熱者的"..CKWord("傷害", "Damage_rgb_tw").."提升 "..CNumb("{damage:%s}", "dmg_var_rgb"),
		...
		["loc_trait_melee_common_wield_increased_disgustingly_resilient_damage_desc"] = { -- damage: +25%
			...
			["zh-tw"] = "對感染敵人的"..CKWord("傷害", "Damage_rgb_tw").."提升 "..CNumb("{damage:%s}", "dmg_var_rgb"),
		...
		["loc_trait_melee_common_wield_increased_resistant_damage_desc"] = { -- damage: +25%
			...
			["zh-tw"] = "對不屈敵人的"..CKWord("傷害", "Damage_rgb_tw").."提升 "..CNumb("{damage:%s}", "dmg_var_rgb"),
		...
		["loc_trait_melee_common_wield_increased_super_armor_damage_desc"] = { -- damage: +25%
			...
			["zh-tw"] = "對甲殼護甲敵人的"..CKWord("傷害", "Damage_rgb_tw").."提升 "..CNumb("{damage:%s}", "dmg_var_rgb"),
		...
		["loc_trait_melee_common_wield_increased_unarmored_damage_desc"] = { -- damage: +25%
			...
			["zh-tw"] = "對無護甲敵人的"..CKWord("傷害", "Damage_rgb_tw").."提升 "..CNumb("{damage:%s}", "dmg_var_rgb"),
		...
		["loc_trait_melee_common_wield_increase_critical_hit_chance_desc"] = { -- crit_chance: +5%
			...
			["zh-tw"] = CNumb("{crit_chance:%s}", "crit_var_rgb").." "..CKWord("近戰爆擊率", "Crit_m_chance_rgb_tw"),
		...
		["loc_trait_melee_common_wield_increase_horde_enemy_damage_desc"] = { -- damage: +10%
			...
			["zh-tw"] = "對呻吟者、瘟疫行者的"..CKWord("傷害", "Damage_rgb_tw").."提升 "..CNumb("{damage:%s}", "dmg_var_rgb"),
		...
		["loc_trait_melee_common_wield_increase_elite_enemy_damage_desc"] = { -- damage: +10%
			...
			["zh-tw"] = "對精英的"..CKWord("傷害", "Damage_rgb_tw").."提升 "..CNumb("{damage:%s}", "dmg_var_rgb"),
		...
		["loc_trait_melee_common_wield_increase_special_enemy_damage_desc"] = { -- damage: +10%
			...
			["zh-tw"] = "對專家的"..CKWord("傷害", "Damage_rgb_tw").."提升 "..CNumb("{damage:%s}", "dmg_var_rgb"),
		...
		["loc_trait_melee_common_wield_reduce_block_cost_desc"] = { -- 
			...
			["zh-tw"] = CNumb("{reduced_block_cost:%s}", "rbc_rgb").." 格檔效率",
		...
		["loc_gadget_sprint_cost_reduction_desc"] = { -- 
			...
			["zh-tw"] = CNumb("{sprinting_cost_multiplier:%s}", "bcm_rgb").." "..CKWord("衝刺體力消耗", "Stamina_se_rgb_tw"),
	...
	--[+ RANGED - 遠程武器 - 远程武器 +]--
		...
		["loc_trait_ranged_common_wield_increase_crit_chance_desc"] = {
			...
			["zh-tw"] = CNumb("{crit_chance:%s}", "crit_var_rgb").." "..CKWord("遠程爆擊率", "Crit_r_chance_rgb_tw"),
		...
		["loc_trait_ranged_common_wield_increase_elite_enemy_damage_desc"] = {
			...
			["zh-tw"] = "對精英的"..CKWord("遠程傷害", "Damage_r_rgb_tw").."提升 "..CNumb("{damage:%s}", "dmg_var_rgb"),
		...
		["loc_trait_ranged_common_wield_increase_horde_enemy_damage_desc"] = {
			...
			["zh-tw"] = "對呻吟者、瘟疫行者的"..CKWord("遠程傷害", "Damage_r_rgb_tw").."提升 "..CNumb("{damage:%s}", "dmg_var_rgb"),
		...
		["loc_trait_ranged_common_wield_increase_special_enemy_damage_desc"] = {
			...
			["zh-tw"] = "對專家的"..CKWord("遠程傷害", "Damage_r_rgb_tw").."提升 "..CNumb("{damage:%s}", "dmg_var_rgb"),
...
--[+ ++WEAPON BLESSINGS - БЛАГОСЛОВЕНИЯ ОРУЖИЯ - 武器祝福++ +]--
	--[+ MELEE - БЛИЖНИЙ БОЙ - 近戰 +]--
		...
		["loc_trait_bespoke_melee_rending_vs_staggered_desc"] = { -- rending: +25%, +colors, +note
			...
			fr = CNumb("{rending:%s}", "rending_var_rgb").." "..CKWord("Déchirure", "Rending_rgb_fr").." de mêlée contre les ennemis "..CKWord("Étourdies", "Staggered_rgb_fr")..".\n"
				..CNote("Rend_note"),
			["zh-tw"] = "對"..CKWord("踉蹌", "Staggered_rgb_tw").."敵人獲得 "..CNumb("{rending:%s}", "rending_var_rgb").." 近戰"..CKWord("撕裂", "Rending_rgb_tw").."。\n"
				..CNote("Rend_note"),
		...
		["loc_trait_bespoke_bleed_on_activated_hit_desc"] = { -- stacks: +14, +colors
			...
			["zh-tw"] = "特殊攻擊施加 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 層 "..CKWord("流血", "Bleed_rgb_tw").."。持續 "..CNumb("1.5", "n_1_5_rgb").." 秒，每 "..CNumb("0.5", "n_0_5_rgb").." 秒觸發一次。\n"..CPhrs("Refr_dur_stappl")..CPhrs("Cant_appl_thr_shlds"), -- 放血者
		...
		["loc_trait_bespoke_increase_power_on_hit_desc"] = { -- power_level: +5%, time: 3.5, stacks: 5, s->seconds, +colors, +note
			...
			["zh-tw"] = "命中時獲得 "..CNumb("{power_level:%s}", "pwrlvl_var_rgb").." "..CKWord("威力", "Strength_rgb_tw").."，持續 "..CNumb("{time:%s}", "time_var_rgb").." 秒。\n可疊加 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 層。"..CPhrs("Gen_mult_stacks_n_refr")..CNote("Pwr_note"), -- 奪顱者
		...
		["loc_trait_bespoke_increase_power_on_kill_desc"] = { -- power_level: +5%, time: 4.5, stacks: 5, s->seconds, +colors, +added info, +note
			...
			["zh-tw"] = "擊殺敵人時獲得 "..CNumb("{power_level:%s}", "pwrlvl_var_rgb").." "..CKWord("威力", "Strength_rgb_tw").."，持續 "..CNumb("{time:%s}", "time_var_rgb").." 秒。\n可疊加 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 層。"..CPhrs("Gen_mult_stacks_n_refr")..CNote("Pwr_note"), -- 殺戮者
	...
	--[+ SHRED +]-- ruof Расстрел	20.04.2026
		...
		["loc_trait_bespoke_increased_melee_damage_on_multiple_hits_desc"] = { -- multiple_hit: 3, damage: 36%, time: 3, Damage -> Strength, +colors, +added info, +note
			...
			["zh-tw"] = "當一次攻擊命中至少 "..CNumb("{multiple_hit:%s}", "mult_hit_var_rgb").." 名敵人時，\n"..CNumb("{damage:%s}", "dmg_var_rgb").." "..CKWord("威力", "Strength_rgb_tw").."，持續 "..CNumb("{time:%s}", "time_var_rgb").." 秒。"..CPhrs("Can_be_refr")..CNote("Pwr_note"),
		...
		["loc_trait_bespoke_infinite_cleave_on_weakspot_kill_desc"] = { -- weakspot_damage: 15%, +colors, +added info
			...
			["zh-tw"] = CNumb("{weakspot_damage:%s}", "wkspdmg_var_rgb").." "..CKWord("弱點傷害", "Weakspot_dmg_rgb_tw").."。\n"..CKWord("弱點擊殺", "Weakspot_k_dmg_rgb_tw").."後，近戰攻擊無視最多 "..CNumb("3", "n_3_rgb").." 名非歐格林敵人的"..CKWord("順劈目標", "Hit_mass_rgb_tw").."。"..CNote("Hit_Mass_note"),
		...
		["loc_trait_bespoke_power_bonus_on_first_attack_desc"] = { -- power_level: +60%, cooldown: 3.5, +colors, +note
			...
			["zh-tw"] = "每 "..CNumb("{cooldown:%s}", "cd_var_rgb").." 秒，第一次攻擊增加 "..CNumb("{power_level:%s}", "pwrlvl_var_rgb").." "..CKWord("威力", "Strength_rgb_tw").."。"..CNote("Pwr_note"),
		...
		["loc_trait_bespoke_power_bonus_scaled_on_stamina_desc"] = { -- power_level: +8%, rewrited, +colors, +note
			...
			["zh-tw"] = "每缺少 "..CNumb("20%", "pc_20_rgb").." "..CKWord("耐力", "Stamina_rgb_tw").."，獲得 "..CNumb("1", "n_1_rgb").." 層 "..CNumb("+", "n_plus_rgb")..CNumb("8%", "pc_8_rgb").." "..CKWord("威力", "Strength_rgb_tw").."。可疊加 "..CNumb("5", "n_5_rgb").." 層，最多 "..CNumb("{power_level:%s}", "pwrlvl_var_rgb").." "..CKWord("威力", "Strength_rgb_tw").."。"..Dot_red.." T4 描述！\n"
				..Dot_nc.." T1: "..CNumb("+", "n_plus_rgb")..CNumb("5%", "pc_5_rgb").." | T2: "..CNumb("+", "n_plus_rgb")..CNumb("6%", "pc_6_rgb").." | T3: "..CNumb("+", "n_plus_rgb")..CNumb("7%", "pc_7_rgb").."。"..CNote("Pwr_note"),
		...
		["loc_trait_bespoke_stacking_rending_on_one_hit_kills_desc"] = { -- finesse: +24%, time: 5, stacks: 5, s->seconds, +colors, +note
			...
			["zh-tw"] = "一擊擊殺敵人時，獲得 "..CNumb("{finesse:%s}", "fin_var_rgb").." "..CKWord("靈巧", "Finesse_rgb_tw").."，持續 "..CNumb("{time:%s}", "time_var_rgb").." 秒。可疊加 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 層。"
				..CPhrs("Can_be_refr").."\n"
				..CNote("Fns_note"),
		...
		["loc_trait_bespoke_dodge_count_reset_on_weakspot_hit_and_weakspot_damage_desc"] = { -- melee_weakspot_damage: +10%, +colors
			...
			["zh-tw"] = CNumb("{melee_weakspot_damage}", "mel_weapsp_dmg_var_rgb").." 近戰"..CKWord("弱點傷害", "Weakspot_dmg_rgb_tw").."。\n"..CKWord("弱點命中", "Weakspothit_rgb_tw").."時刷新閃避效率。",
		...
		["loc_trait_bespoke_power_bonus_on_same_enemy_attacks_desc"] = { -- power_level: +10%, time: 2, stacks: 5, s->seconds, +colors
			...
			["zh-tw"] = "命中同一敵人時獲得 "..CNumb("{power_level:%s}", "pwrlvl_var_rgb").." "..CKWord("威力", "Strength_rgb_tw").."，持續 "..CNumb("{time:%s}", "time_var_rgb").." 秒。可疊加 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 層。"
				..CPhrs("Can_be_refr").."\n"
				..CNote("Pwr_note"),
		...
		["loc_trait_bespoke_bleed_on_non_weakspot_hit_desc"] = { -- stacks: +4, +colors
			...
			["zh-tw"] = "非 "..CKWord("弱點命中", "Weakspothits_rgb_tw").."時施加 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 層 "..CKWord("流血", "Bleed_rgb_tw").."。\n"
				..Dot_nc.." 最多 "..CNumb("16", "n_16_rgb").." 層。"..Dot_nc.." 持續 "..CNumb("1.5", "n_1_5_rgb").." 秒。\n"
				..CPhrs("Refr_dur_stappl")..CPhrs("Cant_appl_thr_shlds"),
		...
		["loc_trait_bespoke_chained_weakspot_hits_increases_power_desc"] = { -- power_level: +6%, stacks: 5, +colors
			...
			["zh-tw"] = "連續"..CKWord("弱點命中", "Weakspothit_rgb_tw").."時獲得 "..CNumb("{power_level:%s}", "pwrlvl_var_rgb").." "..CKWord("威力", "Strength_rgb_tw").."。可疊加 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 層。"
				..Dot_nc.." 層數持續 "..CNumb("2.5", "n_2_5_rgb").." 秒。\n"
				..CPhrs("Can_be_refr")..CNote("Pwr_note"),
		...
		["loc_trait_bespoke_dodge_grants_finesse_bonus_desc"] = { -- damage: +60%, time: 2, s->seconds, +colors, +note
			...
			["zh-tw"] = "成功閃避時獲得 "..CNumb("{damage:%s}", "dmg_var_rgb").." "..CKWord("靈巧傷害", "Finesse_dmg_rgb_tw").."，持續 "..CNumb("{time:%s}", "time_var_rgb").." 秒。"..CNote("Fns_note"),
		...
		["loc_trait_bespoke_rending_on_backstabs_desc"] = { -- rending: +100%, +colors
			...
			["zh-tw"] = "背刺命中時獲得 "..CNumb("{rending:%s}", "rending_var_rgb").." "..CKWord("撕裂", "Rending_rgb_tw").."。"
				..Dot_nc.." 啟用背刺。"..CNote("Rend_note"),
		...
		["loc_trait_bespoke_stacking_rending_debuff_on_weakspot_desc"] = { -- rending: +24%, time: 3.5, stacks: 5, s->seconds, +colors
			en = CNumb("+", "n_plus_rgb")..CNumb("{stacks:%s}", "stacks_var_rgb").." Stacks of "..CNumb("{rending:%s}", "rending_var_rgb").." "..CKWord("Brittleness", "Brittleness_rgb").." for "..CNumb("{time:%s}", "time_var_rgb").." seconds on Enemy "..CKWord("Weakspot Hit", "Weakspothit_rgb")..". Up to "..CNumb("40%", "pc_40_rgb").." at "..CNumb("{max_stacks:%s}", "maxstks_var_rgb").." Stacks. "
				..CPhrs("Can_be_refr")
				..CNote("Brtl_note"),
			ru = CNumb("+", "n_plus_rgb")..CNumb("{stacks:%s}", "stacks_var_rgb").." зарядов "..CNumb("{rending:%s}", "rending_var_rgb").." "..CKWord("хрупкости", "hrupkosti_rgb_ru").." брони на "..CNumb("{time:%s}", "time_var_rgb").." секунд при попадании в "..CKWord("уязвимое место", "ujazvimoe_mesto_rgb_ru")..". Вплоть до "..CNumb("40%", "pc_40_rgb").." при "..CNumb("{max_stacks:%s}", "maxstks_var_rgb").." зарядах. "
				..CPhrs("Can_be_refr")
				..CNote("Brtl_note"),
			fr = CNumb("+", "n_plus_rgb")..CNumb("{stacks:%s}", "stacks_var_rgb").." Cumuls de "..CNumb("{rending:%s}", "rending_var_rgb").." de "..CKWord("Fragilité", "Brittleness_rgb_fr").." pendant "..CNumb("{time:%s}", "time_var_rgb").." secondes sur un "..CKWord("Coup sur point faible", "Weakspothit_rgb_fr")..". Jusqu'à "..CNumb("40%", "pc_40_rgb").." à "..CNumb("{max_stacks:%s}", "maxstks_var_rgb").." Cumuls. "
				..CPhrs("Can_be_refr")
				..CNote("Brtl_note"),
			["zh-tw"] = CKWord("命中弱點", "Weakspothit_rgb_tw").."時，使目標獲得 "..CNumb("+", "n_plus_rgb")..CNumb("{stacks:%s}", "stacks_var_rgb").." 層 "..CNumb("{rending:%s}", "rending_var_rgb").." "..CKWord("脆弱", "Brittleness_rgb_tw").."，持續 "..CNumb("{time:%s}", "time_var_rgb").." 秒。"
				.."在 "..CNumb("{max_stacks:%s}", "maxstks_var_rgb").." 層時最高 "..CNumb("40%", "pc_40_rgb").."。"
				..CPhrs("Can_be_refr")
				..CNote("Brtl_note"),
			["zh-cn"] = CKWord("命中弱点", "Weakspothit_rgb_zh_cn").."时，施加 "..CNumb("+", "n_plus_rgb")..CNumb("{stacks:%s}", "stacks_var_rgb").." 层 "..CNumb("{rending:%s}", "rending_var_rgb").." "..CKWord("脆弱", "Brittleness_rgb_zh_cn").."，\n持续 "..CNumb("{time:%s}", "time_var_rgb").." 秒。\n最多叠加 "..CNumb("{max_stacks:%s}", "maxstks_var_rgb").." 层，最高 "..CNumb("40%", "pc_40_rgb").." 。 "
				..CPhrs("Can_be_refr")
				..CNote("Brtl_note"),
			de = CNumb("+", "n_plus_rgb")..CNumb("{stacks:%s}", "stacks_var_rgb").." Stapel von "..CNumb("{rending:%s}", "rending_var_rgb").." "..CKWord("Sprödigkeit", "Brittleness_rgb_de").." für "..CNumb("{time:%s}", "time_var_rgb").." Sek. bei einem "..CKWord("Schwachstellentreffer", "Weakspothit_rgb_de")..". Bis zu "..CNumb("40%", "pc_40_rgb").." bei "..CNumb("{max_stacks:%s}", "maxstks_var_rgb").." Stapeln. "
				..CPhrs("Can_be_refr")
				..CNote("Brtl_note"),
			it = CNumb("+", "n_plus_rgb")..CNumb("{stacks:%s}", "stacks_var_rgb").." accumuli di "..CNumb("{rending:%s}", "rending_var_rgb").." di "..CKWord("Fragilità", "Brittleness_rgb_it").." per "..CNumb("{time:%s}", "time_var_rgb").." sec. con un "..CKWord("Colpo a Punto Debole", "Weakspothit_rgb_it")..". Fino al "..CNumb("40%", "pc_40_rgb").." a "..CNumb("{max_stacks:%s}", "maxstks_var_rgb").." accumuli. "
				..CPhrs("Can_be_refr")
				..CNote("Brtl_note"),
			ja = CKWord("弱点ヒット", "Weakspothit_rgb_ja").."時、"..CNumb("{time:%s}", "time_var_rgb").."秒間、"..CNumb("+", "n_plus_rgb")..CNumb("{stacks:%s}", "stacks_var_rgb").." スタックの "..CNumb("{rending:%s}", "rending_var_rgb").." "..CKWord("脆弱", "Brittleness_rgb_ja").."を付与。最大 "..CNumb("{max_stacks:%s}", "maxstks_var_rgb").." スタックで "..CNumb("40%", "pc_40_rgb").." まで上昇。 "
				..CPhrs("Can_be_refr")
				..CNote("Brtl_note"),
			ko = CKWord("약점 적중", "Weakspothit_rgb_ko").." 시 "..CNumb("{time:%s}", "time_var_rgb").."초 동안 "..CNumb("+", "n_plus_rgb")..CNumb("{stacks:%s}", "stacks_var_rgb").." 중첩의 "..CNumb("{rending:%s}", "rending_var_rgb").." "..CKWord("취약", "Brittleness_rgb_ko").."을 부여합니다. 최대 "..CNumb("{max_stacks:%s}", "maxstks_var_rgb").." 중첩 시 "..CNumb("40%", "pc_40_rgb").." 까지 증가. "
				..CPhrs("Can_be_refr")
				..CNote("Brtl_note"),
		...
		["loc_trait_bespoke_consecutive_hits_increases_stagger_desc"] = { -- impact: +20%, time: 2, stacks: 5, +colors
			...
			["zh-tw"] = "重複命中時獲得 "..CNumb("{impact:%s}", "impact_var_rgb").." "..CKWord("衝擊", "Impact_rgb_tw").."，持續 "..CNumb("{time:%s}", "time_var_rgb").." 秒。可疊加 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 層。"
				..CPhrs("Can_be_refr"),
		...
		["loc_trait_bespoke_increase_stagger_per_hit_in_sweep_desc"] = { -- impact: +20%, +colors
			...
			["zh-tw"] = "同一次攻擊每先命中一名敵人，對後續目標獲得 "..CNumb("{impact:%s}", "impact_var_rgb").." "..CKWord("衝擊", "Impact_rgb_tw").."。"
		...
		["loc_trait_bespoke_staggered_targets_receive_increased_damage_debuff_desc"] = { -- stacks: 4, damage: +10%, time: 5, Stack(s)->Stacks, +colors
			...
			["zh-tw"] = "若目標已處於"..CKWord("踉蹌", "Staggered_rgb_tw").."狀態，使其獲得 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 層 "..CNumb("{damage:%s}", "dmg_var_rgb").." "..CKWord("傷害", "Damage_rgb_tw").."，目標最多 "..CNumb("8", "n_8_rgb").." 層。持續 "..CNumb("{time:%s}", "time_var_rgb").." 秒。"
				..CPhrs("Can_be_refr"),
		...
		["loc_trait_bespoke_staggered_targets_receive_increased_stagger_debuff_desc"] = { -- stacks: 4, impact: +10%, time: 5, Stack(s)->Stacks, +colors
			...
			["zh-tw"] = "若目標已處於"..CKWord("踉蹌", "Staggered_rgb_tw").."狀態，使其獲得 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 層 "..CNumb("{impact:%s}", "impact_var_rgb").." "..CKWord("衝擊", "Impact_rgb_tw").."，目標最多 "..CNumb("8", "n_8_rgb").." 層。持續 "..CNumb("{time:%s}", "time_var_rgb").." 秒。"
				..CPhrs("Can_be_refr"),
		...
		["loc_trait_bespoke_increased_crit_chance_on_weakspot_kill_desc"] = { -- crit_chance: +20%, time: 3, s->seconds, +colors
			...
			["zh-tw"] = CKWord("弱點", "Weakspot_rgb_tw").."擊殺時獲得 "..CNumb("{crit_chance:%s}", "crit_var_rgb").." "..CKWord("爆擊率", "Crit_chance_rgb_tw").."，持續 "..CNumb("{time:%s}", "time_var_rgb").." 秒。"
				..CPhrs("Can_be_refr"),
		...
		["loc_trait_bespoke_pass_past_armor_on_crit_new_desc"] = { -- crit_damage: +10%, +colors
			...
			["zh-tw"] = CNumb("{crit_damage:%s}", "critdmg_var_rgb").." 近戰"..CKWord("致命一擊", "Crit_hit_rgb_tw")..CKWord("傷害", "Damage_rgb_tw").."。"..CKWord("致命一擊", "Crit_hits_rgb_tw").."會無視護甲提供的"..CKWord("順劈目標", "Hit_mass_rgb_tw").."加成。\n"
		...
		["loc_trait_bespoke_stacking_melee_rending_on_cleave_desc"] = { -- rending: +8%, time: 4, stacks: 4, +colors, +note
			...
			["zh-tw"] = "近戰攻擊命中 "..CNumb("2", "n_2_rgb").." 名以上敵人時，獲得 "..CNumb("{rending:%s}", "rending_var_rgb").." 近戰"..CKWord("撕裂", "Rending_rgb_tw").."，持續 "..CNumb("{time:%s}", "time_var_rgb").." 秒。可疊加 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 層。"
				..CPhrs("Can_be_refr")..CNote("Rend_note"),
		...
		["loc_trait_bespoke_can_block_ranged_desc"] = { -- block_cost: 30%, +colors
			...
			["zh-tw"] = CNumb("{block_cost:%s}", "block_var_rgb").." 格擋消耗。此武器可格擋近戰與遠程攻擊。",
		...
		["loc_trait_bespoke_vent_warp_charge_on_multiple_hits_desc"] = { -- multiple_hit: 3, warp_charge: 2%, +colors
			...
			["zh-tw"] = "一次攻擊命中至少 "..CNumb("{multiple_hit:%s}", "mult_hit_var_rgb").." 名敵人時，抑制 "..CNumb("{warp_charge:%s}", "warpchrg_var_rgb").." "..CKWord("反噬", "Peril_rgb_tw").."。"
				..Dot_nc.." 每次攻擊只觸發一次。"..Dot_red.." 無法由特殊攻擊觸發。",
		...
		["loc_trait_bespoke_warp_burninating_on_crit_desc"] = { -- stacks: +4, max_stacks: 12, Stack(s)->Stacks, +colors
			...
			["zh-tw"] = "敵人受到"..CKWord("致命一擊", "Crit_hit_rgb_tw").."時，獲得 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 層"..CKWord("靈魂之火", "Soulblaze_rgb_tw").."，最多 "..CNumb("{max_stacks:%s}", "maxstks_var_rgb").." 層。\n"
				..Dot_nc.." 持續 "..CNumb("8", "n_8_rgb").." 秒。"..CPhrs("Refr_dur_stappl")..CPhrs("Cant_appl_thr_shlds"),
		...
		["loc_trait_bespoke_warp_charge_power_bonus_desc"] = { -- power_level: +20%, +colors
			...
			["zh-tw"] = "隨著"..CKWord("反噬", "Peril_rgb_tw").."等級提高，最多獲得 "..CNumb("{power_level:%s}", "pwrlvl_var_rgb").." "..CKWord("威力", "Strength_rgb_tw").."。"
				..Dot_nc.." 可疊加 "..CNumb("4", "n_4_rgb").." 層。"..CNote("Pwr_note"),
		...
		["loc_trait_bespoke_wind_slash_crits_desc"] = { -- cooldown: 50, s->seconds, +colors
			...
			["zh-tw"] = "啟動時保證造成"..CKWord("致命一擊", "Crit_rgb_tw").."。冷卻時間 "..CNumb("{cooldown:%s}", "cd_var_rgb").." 秒。",
		...
		["loc_trait_bespoke_elite_kills_grants_stackable_power_desc"] = { -- stacks: 5, power_level: +12.5%, time: 7, s->seconds, +colors
			...
			["zh-tw"] = "擊殺精英或專家敵人時，獲得 "..CNumb("{power_level:%s}", "pwrlvl_var_rgb").." "..CKWord("威力", "Strength_rgb_tw").."，持續 "..CNumb("{time:%s}", "time_var_rgb").." 秒。可疊加 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 層。"
				..CPhrs("Can_be_refr_drop_1").." "..CNote("Pwr_note"),
		...
		["loc_trait_bespoke_block_has_chance_to_stun_with_cd_desc"] = { -- power_level: 25%, duration: 3, cooldown_duration: 3, +colors
			...
			["zh-tw"] = "完美格擋會使攻擊者"..CKWord("眩暈", "Stuns_rgb_tw").."，並使你獲得 "..CNumb("{power_level:%s}", "pwrlvl_var_rgb").." 近戰"..CKWord("威力", "Strength_rgb_tw").."，持續 "..CNumb("{duration:%s}", "dur_var_rgb").." 秒。冷卻時間 "..CNumb("{cooldown_duration:%s}", "cd_dur_var_rgb").." 秒。"..CNote("Pwr_note"),
		...
		["loc_trait_bespoke_damage_bonus_vs_electrocuded_desc"] = { -- damage: +25%, +colors
			...
			["zh-tw"] = "對"..CKWord("被電擊", "Electrocuted_rgb_tw").."的敵人造成 "..CNumb("{damage:%s}", "dmg_var_rgb").." "..CKWord("傷害", "Damage_rgb_tw").."。",
		...
		["loc_trait_bespoke_negate_stagger_reduction_on_weakspot_desc"] = { -- stagger: 90%, ranged_stagger: 30%, +colors
			...
			["zh-tw"] = CKWord("弱點命中", "Weakspothit_rgb_tw").."時，對敵人施加的"..CKWord("踉蹌效果", "Stagger2_rgb_tw").."提高 "..CNumb("{stagger:%s}", "stgr_var_rgb").."。\n遠程"..CKWord("踉蹌效果", "Stagger2_rgb_tw").."提高 "..CNumb("{ranged_stagger:%s}", "stgrrang_var_rgb").."。",
		...
		["loc_attack_speed_on_perfect_block_desc"] = { -- attack_speed: 10%, duration: 5, interval: 8, +colors
			...
			["zh-tw"] = "完美格擋時，獲得 "..CNumb("{attack_speed:%s}", "attack_spd_var_rgb").." 攻擊速度，持續 "..CNumb("{duration:%s}", "dur_var_rgb").." 秒。每 "..CNumb("{interval:%s}", "interval_var_rgb").." 秒只能觸發一次。"
				..Dot_red.." 啟用期間無法刷新。",
		...
		["loc_chained_weakspot_hits_increase_finesse_and_reduce_overheat_desc"] = { -- buildup_amount: 6%, damage: 4%, duration: 3 , stacks: 5, s->seconds, +colors
			en = CNumb("{buildup_amount:%s}", "buildup_var_rgb").." "..CKWord("Heat", "Heat_rgb").." buildup and "..CNumb("{damage:%s}", "dmg_var_rgb").." "..CKWord("Finesse Damage", "Finesse_dmg_rgb").." for "..CNumb("{duration:%s}", "dur_var_rgb").." seconds on chained "..CKWord("Weakspot Hits", "Weakspothits_rgb")..". Stacks "..CNumb("{stacks:%s}", "stacks_var_rgb").." times. "
				..CPhrs("Can_be_refr"),
			ru = CNumb("{buildup_amount:%s}", "buildup_var_rgb").." к набору "..CKWord("перегрева", "peregreva_rgb_ru").." и "..CNumb("{damage:%s}", "dmg_var_rgb").." к "..CKWord("урону от ловкости", "lovkosti_uron_rgb_ru").." на "..CNumb("{duration:%s}", "dur_var_rgb").." секунды при серии ударов в "..CKWord("уязвимые места", "ujazvimye_mesta_rgb_ru")..". Суммируется "..CNumb("{stacks:%s}", "stacks_var_rgb").." раз. "
				..CPhrs("Can_be_refr"),
			fr = "Réduit la génération de "..CKWord("Chaleur", "Heat_rgb_fr").." de "..CNumb("{buildup_amount:%s}", "buildup_var_rgb").." et augmente les "..CKWord("Dégâts de finesse", "Finesse_dmg_rgb_fr").." de "..CNumb("{damage:%s}", "dmg_var_rgb").." pendant "..CNumb("{duration:%s}", "dur_var_rgb").." secondes lors de "..CKWord("Coup sur point faible", "Weakspothit_rgb_fr").." répétés. Se cumule "..CNumb("{stacks:%s}", "stacks_var_rgb").." fois.",
			["zh-tw"] = "連續"..CKWord("弱點命中", "Weakspothits_rgb_tw").."時，獲得 "..CNumb("{buildup_amount:%s}", "buildup_var_rgb").." "..CKWord("熱能", "Heat_rgb_tw").."累積與 "..CNumb("{damage:%s}", "dmg_var_rgb").." "..CKWord("靈巧傷害", "Finesse_dmg_rgb_tw").."，持續 "..CNumb("{duration:%s}", "dur_var_rgb").." 秒。可疊加 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 層。"
				..CPhrs("Can_be_refr"),
			...
			de = "Reduziert den "..CKWord("Hitze", "Heat_rgb_de").."-Aufbau um "..CNumb("{buildup_amount:%s}", "buildup_var_rgb").." und erhöht "..CKWord("Finesseschaden", "Finesse_dmg_rgb_de").." um "..CNumb("{damage:%s}", "dmg_var_rgb").." für "..CNumb("{duration:%s}", "dur_var_rgb").." Sek. bei aufeinanderfolgenden "..CKWord("Schwachstellentreffern", "Weakspothits_rgb_de")..". Stapelt "..CNumb("{stacks:%s}", "stacks_var_rgb").." Mal.",
			it = "Riduce l'accumulo di "..CKWord("Calore", "Heat_rgb_it").." del "..CNumb("{buildup_amount:%s}", "buildup_var_rgb").." e aumenta i "..CKWord("Danno da finezza", "Finesse_dmg_rgb_it").." del "..CNumb("{damage:%s}", "dmg_var_rgb").." per "..CNumb("{duration:%s}", "dur_var_rgb").." sec. a "..CKWord("Colpi a Punto Debole", "Weakspothits_rgb_it").." ripetuti. Cumulabile "..CNumb("{stacks:%s}", "stacks_var_rgb").." volte.",
		...
		["loc_power_bonus_scaled_on_heat_desc"] = { -- amount: 4%, +colors
			...
			["zh-tw"] = "依據"..CKWord("熱能", "Heat_rgb_tw").."，最多獲得 "..CNumb("{amount}", "amount_var_rgb").." "..CKWord("威力", "Strength_rgb_tw").."。"..CNote("Pwr_note"),
		...
		["loc_slower_heat_buildup_on_perfect_block_desc"] = { -- heat_reduction: 20%, heat_dissipation: 5%, time: 5, interval: 8, +colors
			...
			["zh-tw"] = "完美格擋時，降低 "..CNumb("{heat_reduction:%s}", "heat_red_var_rgb").." "..CKWord("熱能", "Heat_rgb_tw").."累積，並提高 "..CNumb("{heat_dissipation:%s}", "heat_diss_var_rgb").." "..CKWord("熱能消散", "Heat_diss_rgb_tw").."，持續 "..CNumb("{time:%s}", "time_var_rgb").." 秒。每 "..CNumb("{interval:%s}", "interval_var_rgb").." 秒只能觸發一次。",
		...
		["loc_trait_bespoke_hit_mass_consumption_reduction_on_kill_desc"] = { -- hit_mass: -40%, time: 2, s->seconds, +colors
			...
			["zh-tw"] = "擊殺時，敵人"..CKWord("順劈目標", "Hit_mass_rgb_tw").." "..CNumb("{hit_mass:%s}", "hitmass_var_rgb").."，持續 "..CNumb("{time:%s}", "time_var_rgb").." 秒。"
				..CPhrs("Can_be_refr"),
		...
		["loc_trait_bespoke_armor_rend_on_activated_attacks_desc"] = { -- rend: +4, +colors
			...
			ru = "До "..CNumb("{rend:%s}", "rend_var_rgb").." зарядов "..CKWord("хрупкости", "hrupkosti_rgb_ru").." брони применяется к врагу при заряженном ударе.\n"
				..CPhrs("Can_be_refr").."\n"
				..CNote("Brtl_note"),
			fr = CNumb("{rend:%s}", "rend_var_rgb").." cumuls de "..CKWord("Fragilité", "Brittleness_rgb_fr").." lors d'un coup énergisé."..CNote("Brtl_note"),
			["zh-tw"] = "充能命中時，對敵人施加 "..CNumb("{rend:%s}", "rend_var_rgb").." 層 "..CKWord("脆弱", "Brittleness_rgb_tw").."。\n"
				..CPhrs("Can_be_refr")..CNote("Brtl_note"),
		...
		["loc_trait_bespoke_extended_activation_duration_and_stagger_on_chained_attacks_desc"] = { -- extra_hits: +2, stagger: +10%, +colors
			...
			["zh-tw"] = CNumb("+", "n_plus_rgb")..CNumb("{extra_hits:%s}", "extrahits_var_rgb").." 次額外連續充能命中，且\n充能命中時 "..CNumb("+", "n_plus_rgb")..CNumb("{stagger:%s}", "stgr_var_rgb").." "..CKWord("衝擊", "Impact_rgb_tw").."。"
				..CNote("Impact_note"),
		...
		["loc_trait_bespoke_increased_crit_chance_after_punch_desc"] = { -- crit_chance: +15%, time: 3, +colors
			...
			["zh-tw"] = "特殊動作命中時 "..CNumb("{crit_chance:%s}", "crit_var_rgb").." "..CKWord("爆擊率", "Crit_chance_rgb_tw").."，\n持續 "..CNumb("{time:%s}", "time_var_rgb").." 秒。"
				..CPhrs("Can_be_refr")..Dot_red.." 不會強化遠程武器。",
			["zh-cn"] = "特殊攻击命中敌人时 \n"..CNumb("{crit_chance:%s}", "crit_var_rgb").." 近战"..CKWord("暴击几率", "Crit_chance_rgb_zh_cn").."，持续 "..CNumb("{time:%s}", "time_var_rgb").." 秒。",
		...
		["loc_trait_bespoke_toughness_recovery_on_chained_attacks_desc"] = { -- toughness: +8%, +colors
			...
			["zh-tw"] = "連續命中時恢復 "..CNumb("{toughness:%s}", "tghns_var_rgb").." "..CKWord("韌性", "Toughness_rgb_tw").."。"
				..Dot_green.." 會額外與天賦提供的"..CKWord("韌性", "Toughness_rgb_tw").."補充一起觸發。 "..CPhrs("Dont_intw_coher_tghn"),
		...
		["loc_trait_bespoke_toughness_regen_on_punching_elites_desc"] = { -- toughness: +8%,  time: 5, s->seconds, +colors
			...
			["zh-tw"] = "特殊動作命中精英時，每秒恢復 "..CNumb("{toughness:%s}", "tghns_var_rgb").." "..CKWord("韌性", "Toughness_rgb_tw").."，持續 "..CNumb("{time:%s}", "time_var_rgb").." 秒。\n"
				..CPhrs("Can_be_refr"),
		...
		["loc_trait_bespoke_crit_chance_on_push_desc"] = { -- crit_chance: +15%,  time: 3, s->seconds, +colors
			...
			["zh-tw"] = "推開敵人時 "..CNumb("{crit_chance:%s}", "crit_var_rgb").." "..CKWord("爆擊率", "Crit_chance_rgb_tw").."，\n持續 "..CNumb("{time:%s}", "time_var_rgb").." 秒。"
				..CPhrs("Can_be_refr"),
		...
		["loc_trait_bespoke_increase_power_on_weapon_special_hit_desc"] = { -- power_level: +24%,  time: 3.5, +colors
			...
			["zh-tw"] = "武器特殊攻擊命中時 "..CNumb("{power_level:%s}", "pwrlvl_var_rgb").." "..CKWord("威力", "Strength_rgb_tw").."，\n持續 "..CNumb("{time:%s}", "time_var_rgb").." 秒。"
				..CPhrs("Can_be_refr").." "..CNote("Pwr_note"),
		...
		["loc_trait_block_break_pushes_new_desc"] = { -- block_cost: -30%, cooldown: 15, +colors
			...
			["zh-tw"] = CNumb("{block_cost:%s}", "block_var_rgb").." 格擋消耗。格擋攻擊使"..CKWord("耐力", "Stamina_rgb_tw").."降至 "..CNumb("0", "n_0_rgb").." 時，\n擊退半徑 "..CNumb("5", "n_5_rgb").." 公尺內的敵人。冷卻時間 "..CNumb("{cooldown:%s}", "cd_var_rgb").." 秒。",
		...
		["loc_trait_damage_bonus_on_block_desc"] = { -- power: +10%, duration: 3.5, stacks: 5, +colors -- ..CNote("Pwr_note_rgb
			...
			["zh-tw"] = "格擋時每消耗一格"..CKWord("耐力", "Stamina_rgb_tw").."，下一次攻擊獲得 "..CNumb("{power:%s}", "pwr_var_rgb").." 近戰"..CKWord("威力", "Strength_rgb_tw").."。\n最多堆疊 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 次，每層持續 "..CNumb("{duration:%s}", "dur_var_rgb").." 秒。\n每次攻擊消耗 "..CNumb("1", "n_1_rgb").." 層，並刷新作用中持續時間。",
		...
		["loc_trait_bespoke_armor_rending_bayonette_crowbar_desc"] = { -- rending: 2.5%, stacks: 4, time: 5, max_stacks: 16, s->seconds, +colors
			...
			["zh-tw"] = "在次要模式下命中敵人時，施加 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 層 "..CNumb("{rending:%s}", "rending_var_rgb").." "..CKWord("脆弱", "Brittleness_rgb_tw").."。\n持續 "..CNumb("{time:%s}", "time_var_rgb").." 秒。最多 "..CNumb("{max_stacks:%s}", "maxstks_var_rgb").." 層，最高 "..CNumb("40%", "pc_40_rgb").."。\n"
				..CNote("Brtl_note"),
	...
	--[+ RANGED - ДАЛЬНИЙ БОЙ - 远程武器 +]-- ruof Обстрел
		...
		["loc_trait_bespoke_allow_flanking_and_increased_damage_when_flanking_desc"] = { -- damage: +40%, +colors
			...
			["zh-tw"] = "從背後射擊敵人時 "..CNumb("{damage:%s}", "dmg_var_rgb").." "..CKWord("傷害", "Damage_rgb_tw").."。",
		...
		["loc_trait_bespoke_consecutive_hits_increases_close_damage_desc"] = { -- damage: +6%, stacks: 5, +colors
			...
			["zh-tw"] = "連續命中時，對 "..CNumb("12.5", "n_12_5_rgb").." 公尺內的敵人造成 "..CNumb("{damage:%s}", "dmg_var_rgb").." "..CKWord("傷害", "Damage_rgb_tw").."。\n堆疊 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 次。\n"
				..CPhrs("Can_be_refr"),
		...
		["loc_trait_bespoke_count_as_dodge_vs_ranged_on_close_kill_desc"] = { -- time: 1, s->second, +colors
			...
			["zh-tw"] = "擊殺 "..CNumb("12.5", "n_12_5_rgb").." 公尺內的敵人後，免疫遠程攻擊 "..CNumb("{time:%s}", "time_var_rgb").." 秒。\n"
				..CPhrs("Can_be_refr"),
		...
		["loc_trait_bespoke_increase_close_damage_on_close_kill_desc"] = { -- close_damage: +10%, time: 3.5, stacks: 5, +colors
			...
			["zh-tw"] = "擊殺 "..CNumb("12.5", "n_12_5_rgb").." 公尺內的敵人後，對 "..CNumb("12.5", "n_12_5_rgb").." 公尺內敵人造成 "..CNumb("{close_damage:%s}", "dmgcls_var_rgb").." "..CKWord("傷害", "Damage_rgb_tw").."，持續 "..CNumb("{time:%s}", "time_var_rgb").." 秒。\n堆疊 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 次。 "
				..CPhrs("Can_be_refr"),
		...
		["loc_trait_bespoke_increase_power_on_close_kill_desc"] = { -- power_level: 6.5%, time: 3.5, stacks: 5, +colors, +note
			...
			["zh-tw"] = "擊殺 "..CNumb("12.5", "n_12_5_rgb").." 公尺內的敵人後，獲得 "..CNumb("{power_level:%s}", "pwrlvl_var_rgb").." "..CKWord("威力", "Strength_rgb_tw").."，持續 "..CNumb("{time:%s}", "time_var_rgb").." 秒。\n最多 "..CNumb("5", "n_5_rgb").." 層。 "
				..CPhrs("Can_be_refr")..CNote("Pwr_note"),
		...
		["loc_trait_bespoke_increased_sprint_speed_desc"] = { -- stamina: 50%, +colors
			...
			["zh-tw"] = "衝刺時若"..CKWord("耐力", "Stamina_rgb_tw").."高於 "..CNumb("{stamina:%s}", "stam_var_rgb").."，獲得遠程攻擊免疫。",
		...
		["loc_trait_bespoke_reload_speed_on_slide_desc"] = { -- reload_speed: 10%, time: 2.5, stacks: 5, +colors, +note
			...
			["zh-tw"] = "擊殺 "..CNumb("12.5", "n_12_5_rgb").." 公尺內的敵人後，獲得 "..CNumb("{reload_speed:%s}", "reload_var_rgb").." 裝填速度，持續 "..CNumb("{time:%s}", "time_var_rgb").." 秒。\n堆疊 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 次。 "
				..CPhrs("Can_be_refr").." "..Dot_red.." 持續傷害擊殺無法觸發。",
		...
		["loc_trait_bespoke_suppression_on_close_kill_desc"] = { -- rewrited, +colors, 5m->5meters
			...
			["zh-tw"] = "擊殺 "..CNumb("12.5", "n_12_5_rgb").." 公尺內的敵人後，壓制 "..CNumb("12.5", "n_12_5_rgb").." 公尺內的敵人。",
		...
		["loc_trait_bespoke_movement_speed_on_continuous_fire_desc"] = { -- movement_speed: 25%, ammo: 5%, stacks: 5, s->seconds, +colors
			...
			["zh-tw"] = "持續射擊時，每消耗彈匣的 "..CNumb("{ammo:%s}", "ammo_var_rgb").."，降低 "..CNumb("{movement_speed:%s}", "movspd_var_rgb").." 移動速度懲罰。\n堆疊 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 次。",
		...
		["loc_trait_bespoke_suppression_on_continuous_fire_desc"] = { -- suppression: +20%, damage_vs_suppressed: +6%, ammo: 2.5%, stacks: 5, +colors
			...
			["zh-tw"] = "持續射擊時，每消耗彈匣的 "..CNumb("{ammo:%s}", "ammo_var_rgb").."，獲得 "..CNumb("{suppression:%s}", "spprsn_var_rgb").." 壓制，並對被壓制敵人造成 "..CNumb("{damage_vs_suppressed}", "dmgvsprsd_var_rgb").." "..CKWord("傷害", "Damage_rgb_tw").."。\n堆疊 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 次。",
		...
		["loc_trait_bespoke_toughness_on_continuous_fire_desc"] = { -- toughness: +4%, ammo: 10%, stacks: 5, +colors
			...
			["zh-tw"] = "持續射擊時，每消耗彈匣的 "..CNumb("{ammo:%s}", "ammo_var_rgb").."，獲得 "..CNumb("{toughness:%s}", "tghns_var_rgb").." "..CKWord("韌性", "Toughness_rgb_tw").."。\n堆疊 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 次。",
		...
		["loc_trait_bespoke_count_as_dodge_vs_ranged_on_weakspot_desc"] = { -- time: 1.2, +colors
			...
			["zh-tw"] = CKWord("命中弱點", "Weakspothit_rgb_tw").."時，免疫遠程攻擊 "..CNumb("{time:%s}", "time_var_rgb").." 秒。 "
				..CPhrs("Can_be_refr"),
			["zh-cn"] = CKWord("命中弱点", "Weakspothit_rgb_zh_cn").."时，\n闪避全部远程攻击，持续 "..CNumb("{time:%s}", "time_var_rgb").." 秒。",
		...
		["loc_trait_bespoke_crit_chance_based_on_aim_time_desc"] = { -- crit_chance: +10%, time: 0.2, stacks: 10, +colors, second->seconds
			...
			["zh-tw"] = "瞄準時，每 "..CNumb("{time:%s}", "time_var_rgb").." 秒獲得 "..CNumb("{crit_chance:%s}", "crit_var_rgb").." "..CKWord("暴擊機率", "Crit_chance_rgb_tw").."。\n堆疊 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 次。射擊時釋放所有層數。\n"
				..Dot_nc.." 離開副開火模式時移除所有層數。",
		...
		["loc_trait_bespoke_crit_chance_based_on_ammo_left_desc"] = { -- crit_chance: +0.6%, +colors
			...
			["zh-tw"] = "武器每消耗一發彈藥，獲得 "..CNumb("{crit_chance:%s}", "crit_var_rgb").." "..CKWord("暴擊機率", "Crit_chance_rgb_tw").."。\n重新裝填時重置。",
		...
		["loc_trait_bespoke_crit_weakspot_finesse_desc"] = { -- crit_weakspot_damage: +100%, +colors
			...
			["zh-tw"] = CNumb("{crit_weakspot_damage:%s}", "critwkspdmg_var_rgb").." "..CKWord("暴擊", "Critical_rgb_tw").." "..CKWord("弱點傷害", "Weakspot_dmg_rgb_tw").."。",
		...
		["loc_trait_bespoke_stagger_count_bonus_damage_desc"] = { -- damage: +20%, +colors
			...
			["zh-tw"] = "命中"..CKWord("踉蹌中", "Staggered_rgb_tw").."敵人時 "..CNumb("{damage:%s}", "dmg_var_rgb").." "..CKWord("傷害", "Damage_rgb_tw").."。\n敵人承受的"..CKWord("傷害", "Damage_rgb_tw").."會依施加於其身上的"..CKWord("踉蹌", "Staggering_rgb_tw").."效果強度提高。堆疊 "..CNumb("7", "n_7_rgb").." 次。",
		...
		["loc_trait_bespoke_weakspot_stacking_crit_chance_desc"] = { -- crit_chance: +20%, stacks: 5, +colors
			...
			["zh-tw"] = CKWord("命中弱點", "Weakspothit_rgb_tw").."時獲得 "..CNumb("{crit_chance:%s}", "crit_var_rgb").." "..CKWord("暴擊機率", "Crit_chance_rgb_tw").."，直到下一次"..CKWord("暴擊命中", "Crit_hit_rgb_tw").."。\n堆疊 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 次。",
		...
		["loc_trait_bespoke_suppression_negation_on_weakspot_desc"] = { -- time: 3.6, s->seconds, +colors
			...
			["zh-tw"] = CKWord("命中弱點", "Weakspothit_rgb_tw").."時獲得壓制免疫，持續 "..CNumb("{time:%s}", "time_var_rgb").." 秒。 "
				..CPhrs("Can_be_refr"),
		...
		["loc_trait_bespoke_power_bonus_on_continuous_fire_desc"] = { -- power_level: +8%, ammo: 10%, stacks: 5, +colors
			...
			["zh-tw"] = "持續射擊時，每消耗彈匣的 "..CNumb("{ammo:%s}", "ammo_var_rgb").."，獲得 "..CNumb("{power_level:%s}", "pwrlvl_var_rgb").." "..CKWord("威力", "Strength_rgb_tw").."。\n堆疊 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 次。 "..CNote("Pwr_note"),
		...
		["loc_trait_bespoke_recoil_reduction_and_suppression_increase_on_close_kills_desc"] = { -- damage: +20%, suppression: +40%, recoil_reduction: -40%, +colors
			...
			["zh-tw"] = "擊殺 "..CNumb("12.5", "n_12_5_rgb").." 公尺內敵人時，對被壓制敵人造成 "..CNumb("{damage:%s}", "dmg_var_rgb").." "..CKWord("傷害", "Damage_rgb_tw").."、"..CNumb("{suppression:%s}", "spprsn_var_rgb").." 壓制，並使後座力 "..CNumb("{recoil_reduction:%s}", "recoil_red_var_rgb").."。 "
				..CPhrs("Can_be_refr"),
		...
		["loc_trait_bespoke_stacking_crit_bonus_on_continuous_fire_desc"] = { -- crit_chance: +20%, ammo: 10%, stacks: 5, +colors
			...
			["zh-tw"] = "持續射擊時，每消耗彈匣的 "..CNumb("{ammo:%s}", "ammo_var_rgb").."，獲得 "..CNumb("{crit_chance:%s}", "crit_var_rgb").." "..CKWord("暴擊機率", "Crit_chance_rgb_tw").."。\n堆疊 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 次。",
		...
		["loc_trait_bespoke_stacking_power_bonus_on_staggering_enemies_desc"] = { -- power_level: +8%, stacks: 5, +colors
			...
			["zh-tw"] = "每使一名敵人"..CKWord("踉蹌", "Staggering_rgb_tw").."，獲得 "..CNumb("{power_level:%s}", "pwrlvl_var_rgb").." "..CKWord("威力", "Strength_rgb_tw").."。\n堆疊 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 次。 "
				..CPhrs("Can_be_refr").."\n"
				..CNote("Pwr_note"),
		...
		["loc_trait_bespoke_allow_hipfire_while_sprinting_and_bonus_stats_desc"] = { -- damage_near: +15%, weapon_spread: 30%, +colors
			...
			["zh-tw"] = "衝刺時，對 "..CNumb("12.5", "n_12_5_rgb").." 公尺內敵人造成 "..CNumb("{damage_near:%s}", "dmgnr_var_rgb").." "..CKWord("傷害", "Damage_rgb_tw").."。"..CNumb("{weapon_spread:%s}", "weapsprd_var_rgb").." 武器散布。\n衝刺時可用此武器腰射。",
		...
		["loc_trait_bespoke_bleed_on_ranged_desc"] = { -- stacks: 4, +colors
			...
			["zh-tw"] = "遠程命中時對敵人施加 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 層 "..CKWord("流血", "Bleed_rgb_tw").."。 "
				..Dot_nc.." 最多 "..CNumb("16", "n_16_rgb").." 層。 "..CPhrs("Refr_dur_stappl")..CPhrs("Cant_appl_thr_shlds"),
		...
		["loc_trait_bespoke_close_explosion_desc"] = { -- radius: +25%, +colors
			...
			["zh-tw"] = CNumb("{radius:%s}", "radius_var_rgb").." 爆炸半徑。近距離射擊會造成爆炸。 "
				..Dot_green.." 此增益會常駐啟用，且同樣套用於所有其他爆炸。",
		...
		["loc_trait_bespoke_crit_chance_bonus_on_melee_kills_desc"] = { -- crit_chance: +20%, time: 3.5, +colors
			...
			["zh-tw"] = "近戰擊殺後，遠程 "..CNumb("{crit_chance:%s}", "crit_var_rgb").." "..CKWord("暴擊機率", "Crit_chance_rgb_tw").."，持續 "..CNumb("{time:%s}", "time_var_rgb").." 秒。 "
				..CPhrs("Can_be_refr"),
		...
		["loc_trait_bespoke_damage_vs_stagger_desc"] = { -- vs_stagger: 20%, +colors
			...
			["zh-tw"] = "對"..CKWord("踉蹌中", "Staggered_rgb_tw").."敵人 "..CNumb("{vs_stagger:%s}", "dmgvsstgr_var_rgb").." "..CKWord("傷害", "Damage_rgb_tw").."加成。",
		...
		["loc_trait_bespoke_toughness_on_elite_kills_desc"] = { -- toughness: +30%, +colors
			...
			["zh-tw"] = "擊殺精英敵人時獲得 "..CNumb("{toughness:%s}", "tghns_var_rgb").." "..CKWord("韌性", "Toughness_rgb_tw").."。 "
				..Dot_green.." 每次射擊可觸發多次。 "..Dot_red.." 持續傷害擊殺無法觸發。",
		...
		["loc_trait_bespoke_faster_charge_on_chained_secondary_attacks_desc"] = { -- charge_time: -8.5%, stacks: 3, +colors
			...
			["zh-tw"] = "連續次要攻擊時，充能時間 "..CNumb("{charge_time:%s}", "chrgtime_var_rgb").."。\n堆疊 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 次。 "
				..Dot_red.." 充能時間不受攻擊速度增益影響。",
		...
		["loc_trait_bespoke_peril_vent_on_weakspot_hit_desc"] = { -- warp_charge: 10%, +colors
			...
			["zh-tw"] = CKWord("命中弱點", "Weakspothit_rgb_tw").."時平息 "..CNumb("{warp_charge:%s}", "warpchrg_var_rgb").." "..CKWord("反噬", "Peril_rgb_tw").."。\n"
				..Dot_green.." "..CKWord("順劈命中", "Cleaving_rgb_tw").."敵人"..CKWord("弱點", "Weakspots_rgb_tw").."時，每次射擊可觸發多次。",
		...
		["loc_trait_bespoke_rend_armor_on_aoe_charge_desc"] = { -- stacks: 8, rending: 2.5%, time: 5, max_stacks: 16, s->seconds, +colors
			...
			["zh-tw"] = "依次要攻擊蓄力時間，最多施加 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 層 "..CNumb("{rending:%s}", "rending_var_rgb").." "..CKWord("脆弱", "Brittleness_rgb_tw").."。\n持續 "..CNumb("{time:%s}", "time_var_rgb").." 秒。最多 "..CNumb("{max_stacks:%s}", "maxstks_var_rgb").." 層，最高 "..CNumb("40%", "pc_40_rgb").."。\n"
				..CNote("Brtl_note"),
		...
		["loc_trait_bespoke_uninterruptable_while_charging_and_movement_desc"] = { -- reduction: 50%, +colors
			...
			["zh-tw"] = "次要攻擊期間的移動速度懲罰 "..CNumb("-", "n_minus_rgb")..CNumb("{reduction:%s}", "red_var_rgb").."。你的次要攻擊無法被中斷。 "
				..Dot_red.." 所有法杖的蓄力動作預設已無法被中斷。",
		...
		["loc_trait_bespoke_armor_rending_from_dot_burning_desc"] = { -- num_stacks: 4, rending_percentage: 1%, duration: 5, max_stacks: 10, +colors
			...
			["zh-tw"] = "直接命中會施加 "..CNumb("{num_stacks:%s}", "stacks_num_var_rgb").." 層 "..CNumb("1%", "pc_1_rgb").." "..CKWord("脆弱", "Brittleness_rgb_tw").."，持續 "..CNumb("{duration:%s}", "dur_var_rgb").." 秒。最高 "..CNumb("20%", "pc_20_rgb").."。 "
				..CPhrs("Can_be_refr").."\n"
				..CNote("Brtl_note"),
		...
		["loc_trait_bespoke_chance_to_explode_elites_on_kill_desc"] = { -- proc_chance: 20%
			...
			["zh-tw"] = "擊殺精英與專家敵人時，有 "..CNumb("{proc_chance:%s}", "procch_var_rgb").." 機率使其爆炸。",
		...
		["loc_trait_bespoke_crit_chance_on_successful_dodge_desc"] = { -- crit_chance: +12.5%, time: 6, +colors
			...
			fr = CNumb("{crit_chance:%s}", "crit_var_rgb").." de "..CKWord("Taux de coup critique", "Crit_chance_rgb_fr").." pendant "..CNumb("{time:%s}", "time_var_rgb").." secondes lors d'une esquive réussie.",
			["zh-tw"] = "成功閃避時，獲得 "..CNumb("{crit_chance:%s}", "crit_var_rgb").." "..CKWord("暴擊機率", "Crit_chance_rgb_tw").."，持續 "..CNumb("{time:%s}", "time_var_rgb").." 秒。 "
				..CPhrs("Can_be_refr")..Dot_red.." 不會強化近戰攻擊。",
		...
		["loc_trait_bespoke_toughness_on_crit_kills_desc"] = { -- toughness: 16%, +colors
			...
			["zh-tw"] = CKWord("暴擊命中", "Crit_hit_rgb_tw").."擊殺時，獲得 "..CNumb("{toughness:%s}", "tghns_var_rgb").." "..CKWord("韌性", "Toughness_rgb_tw").."。 "
				..Dot_green.." 每次射擊可觸發多次；近戰攻擊或特殊近戰動作的"..CKWord("暴擊", "Crit_rgb_tw").."擊殺也可觸發。 "..CPhrs("Dont_intw_coher_toughn"),
		...
		["loc_trait_bespoke_bleed_on_crit_ranged_desc"] = { -- stacks: 6, +colors
			...
			["zh-tw"] = CKWord("暴擊命中", "Crit_hit_rgb_tw").."時，對敵人施加 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 層 "..CKWord("流血", "Bleed_rgb_tw").."。 "
		...
		["loc_trait_bespoke_cleave_on_crit_and_stagger_desc"] = { -- stagger: +25%, +colors
			...
			["zh-tw"] = "遠程攻擊 "..CNumb("{stagger:%s}", "stgr_var_rgb").." "..CKWord("踉蹌", "Stagger_rgb_tw").."。"
				..CKWord("暴擊命中", "Crit_hit_rgb_tw").."時提高"..CKWord("順劈攻擊", "Cleave_rgb_tw").."。 "
				..CPhrs("Carap_cant_cleave"),
		...
		["loc_trait_bespoke_crit_chance_on_hitting_multiple_with_one_shot_desc"] = { -- crit_chance: +12%, stacks: 5, +colors
			...
			["zh-tw"] = "前一次攻擊每命中一名敵人，獲得 "..CNumb("{crit_chance:%s}", "crit_var_rgb").." "..CKWord("暴擊機率", "Crit_chance_rgb_tw").."。堆疊 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 次。\n"
				..Dot_red.." 下一次射擊會移除所有層數，即使射向空處也一樣。",
			["zh-cn"] = "上次攻击每命中一名敌人\n"..CNumb("{crit_chance:%s}", "crit_var_rgb").." "..CKWord("暴击几率", "Crit_chance_rgb_zh_cn").."。最多叠加 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 层。",
		...
		["loc_trait_bespoke_reload_speed_on_ranged_weapon_special_kill_desc"] = { -- reload_speed: 70%, +colors
			...
			["zh-tw"] = "瞄準時以雙管齊發擊殺敵人後，"..CNumb("{reload_speed:%s}", "reload_var_rgb").." 換彈速度。",
		...
		["loc_trait_bespoke_power_bonus_on_chained_weakspot_hits_desc"] = { -- power_level: +6%, stacks: 5, +colors
			...
			["zh-tw"] = "連續"..CKWord("弱點命中", "Weakspothit_rgb_tw").."任意目標時，獲得 "..CNumb("{power_level:%s}", "pwrlvl_var_rgb").." "..CKWord("威力", "Strength_rgb_tw").."。堆疊 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 次。 "
				..CPhrs("Can_be_refr").."\n"
				..CNote("Pwr_note"),
		...
		["loc_trait_bespoke_armor_rend_on_projectile_hit_desc"] = { -- stacks: 4, rending: 2.5%, time: 5, max_stacks: 16, s->seconds, +colors
			...
			["zh-tw"] = "直接投射物命中時，目標獲得 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 層 "..CNumb("{rending:%s}", "rending_var_rgb").." "..CKWord("脆弱", "Brittleness_rgb_tw").."，持續 "..CNumb("{time:%s}", "time_var_rgb").." 秒。最多 "..CNumb("{max_stacks:%s}", "maxstks_var_rgb").." 層，最高 "..CNumb("40%", "pc_40_rgb").."。 "
				..CPhrs("Can_be_refr").."\n"
				..CNote("Brtl_note"),
		...
		["loc_trait_bespoke_ammo_spent_from_reserve_on_crit_desc"] = { -- +colors
			...
			["zh-tw"] = CKWord("暴擊命中", "Crit_hits_rgb_tw").."會消耗備彈，而非目前燃料罐中的彈藥。",
		...
		["loc_trait_bespoke_faster_reload_on_empty_clip_desc"] = { -- reload_speed: +36%, +colors
			...
			["zh-tw"] = "燃料罐為空時 "..CNumb("{reload_speed:%s}", "reload_var_rgb").." 換彈速度。",
		...
		["loc_trait_bespoke_ignore_stagger_reduction_with_primary_on_burning_desc"] = { -- stagger_reduction: 60%, impact_modifier: +45%, +colors
			...
			["zh-tw"] = "主攻擊會無視"..CKWord("燃燒中", "Burning_rgb_tw").."敵人 "..CNumb("{stagger_reduction:%s}", "stgrrdct_var_rgb").." "..CKWord("踉蹌", "Stagger_rgb_tw").."抗性，並造成 "..CNumb("{impact_modifier:%s}", "impmod_var_rgb").." "..CKWord("衝擊", "Impact_rgb_tw").."。",
		...
		["loc_trait_bespoke_power_scales_with_clip_percentage_desc"] = { -- power_level: +5%, stacks: 5, +colors
			...
			["zh-tw"] = "依剩餘彈藥量獲得 "..CNumb("{power_level:%s}", "pwrlvl_var_rgb").." "..CKWord("威力", "Strength_rgb_tw").."。堆疊 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 次。\n"
				..Dot_nc.." 目前所有層數會保留至換彈。\n"
				..CNote("Pwr_note"),
		...
		["loc_trait_bespoke_faster_charge_on_chained_attacks_desc"] = { -- charge_time: -12%, stacks: 5, +colors
			...
			["zh-tw"] = "每層 "..CNumb("{charge_time:%s}", "chrgtime_var_rgb").." 充能時間。連續瞄準蓄力攻擊時堆疊，堆疊 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 次。 "
				..Dot_nc.." 層數會在 "..CNumb("0.4", "n_04_rgb").." 秒後或離開副射擊模式時失效。",
			["zh-cn"] = "连续进行充能攻击时 \n"..CNumb("{charge_time:%s}", "chrgtime_var_rgb").." 蓄力时间。最多叠加 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 层。",
		...
		["loc_trait_bespoke_rend_armor_on_charged_shots_desc"] = { -- min_stack_count: 8, max_stack_count: 12, +colors
			...
			["zh-tw"] = "依充能等級，對命中的敵人施加 "..CNumb("{min_stack_count:%s}", "min_stk_cnt_var_rgb").."-"..CNumb("{max_stack_count:%s}", "max_stk_cnt_var_rgb").." 層 "..CNumb("2.5%", "pc_2_5_rgb").." "..CKWord("脆弱", "Brittleness_rgb_tw").."。\n"
				..Dot_nc.." 最多 "..CNumb("16", "n_16_rgb").." 層，最高 "..CNumb("40%", "pc_40_rgb").."。 "
				..CPhrs("Can_be_refr")..Dot_green.." 可穿透護盾施加層數。\n"
				..CNote("Brtl_note"),
		...
		["loc_trait_bespoke_increased_crit_chance_bonus_based_on_charge_time_desc"] = { -- crit_chance_min: 5%, crit_chance_max: 25%, +colors
			...
			["zh-tw"] = "每 "..CNumb("20%", "pc_20_rgb").." 充能等級獲得 "..CNumb("+", "n_plus_rgb")..CNumb("{crit_chance_min:%s}", "critchmin_var_rgb").." "..CKWord("暴擊機率", "Crit_chance_rgb_tw").."。 "
				..Dot_nc.." 最多堆疊 "..CNumb("5", "n_5_rgb").." 次；在 "..CNumb("91%", "pc_91p_rgb").." 充能等級時最高 "..CNumb("+", "n_plus_rgb")..CNumb("{crit_chance_max:%s}", "critchmax_var_rgb").." "..CKWord("暴擊機率", "Crit_chance_rgb_tw").."。\n"
				..Dot_nc.." 只有副射擊蓄力動作能達到最高層數。",
		...
		["loc_trait_bespoke_crit_chance_scaled_on_heat_desc"] = { -- crit_chance: 50%, ranged_crit_damage: 10%, +colors
			...
			["zh-tw"] = "隨"..CKWord("過熱", "Overheat_rgb_tw").."值獲得層數。\n"
				.."每層獲得：\n"
				..CNumb("{crit_chance:%s}", "crit_var_rgb").." "..CKWord("暴擊機率", "Crit_chance_rgb_tw").."與\n"
				..CNumb("{ranged_crit_damage:%s}", "rangcrtdmg_var_rgb").." "..CKWord("遠程暴擊傷害", "Crit_hit_r_dmg_rgb_tw").."。\n"
				..Dot_nc.." 最多堆疊 "..CNumb("5", "n_5_rgb").." 次。",
		...
		["loc_trait_bespoke_lower_overheat_gives_faster_charge_desc"] = { -- charge_speed: +4%, stacks: 5, +colors
			...
			["zh-tw"] = "低"..CKWord("過熱", "Overheat_rgb_tw").."時，"..CNumb("+{charge_speed:%s}", "p_chrgspd_var_rgb").." 充能速度。最多堆疊 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 次。",
		...
		["loc_trait_bespoke_power_bonus_scaled_on_heat_desc"] = { -- power_level: +8%, stacks: 5, +colors
			...
			["zh-tw"] = "依"..CKWord("熱能", "Heat_rgb_tw").."等級，最多獲得 "..CNumb("{damage:%s}", "dmg_var_rgb").." "..CKWord("威力", "Strength_rgb_tw").."。"..CNote("Pwr_note"),
		...
		["loc_trait_bespoke_reduced_heat_on_continuous_desc"] = { -- +colors
			...
			["zh-tw"] = "連續射擊或蓄力射擊時，每層 "..CNumb("-", "n_minus_rgb")..CNumb("10%", "pc_10_rgb").." "..CKWord("熱能", "Heat_rgb_tw").."產生。"
				..Dot_nc.." 最多堆疊 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 次，總計約 "..CNumb("41%", "pc_41_rgb").." 降低。 "..Dot_red.." T4 描述！\n"
				..Dot_nc.." T1: "..CNumb("-", "n_minus_rgb")..CNumb("4%", "pc_4_rgb").." | T2: "..CNumb("-", "n_minus_rgb")..CNumb("6%", "pc_6_rgb").." | T3: "..CNumb("-", "n_minus_rgb")..CNumb("8%", "pc_8_rgb").."。",
		...
		["loc_trait_bespoke_reduced_overheat_on_crits_desc"] = { -- +colors
			...
			["zh-tw"] = CKWord("暴擊命中", "Crit_hit_rgb_tw").."時，"..CKWord("熱能", "Heat_rgb_tw").."產生 "..CNumb("-", "n_minus_rgb")..CNumb("{heat_percentage:%s}", "heat_pc_var_rgb").."。",
		...
		["loc_trait_bespoke_power_bonus_on_chained_melee_desc"] = { -- power: 5%, stacks: 10, time: 1.5, +colors
			...
			["zh-tw"] = "每層 "..CNumb("{power:%s}", "pwr_var_rgb").." 近戰"..CKWord("威力", "Strength_rgb_tw").."。連續近戰命中時堆疊，最多 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 次。每層持續 "..CNumb("{time:%s}", "time_var_rgb").." 秒。 "
				..CNote("Pwr_note").."\n"
				..Dot_red.." {#color(255, 35, 5)}BUG:{#reset()} 所有等級皆為 "..CNumb("5%", "pc_5_rgb").."。",
		...
		["loc_trait_bespoke_crit_chance_on_melee_kill_desc"] = { -- crit_chance: +25%, time: 3, +colors
			...
			["zh-tw"] = "近戰擊殺時獲得 "..CNumb("{crit_chance:%s}", "crit_var_rgb").." "..CKWord("暴擊機率", "Crit_chance_rgb_tw").."，持續 "..CNumb("{time:%s}", "time_var_rgb").." 秒。",
		...
		["loc_trait_bespoke_melee_power_bonus_after_explosion_desc"] = { -- power_level: 30%, time: 3.5, +colors
			...
			["zh-tw"] = "次要攻擊命中至少 "..CNumb("3", "n_3_rgb").." 名敵人後，獲得 "..CNumb("{power_level:%s}", "pwrlvl_var_rgb").." 近戰"..CKWord("威力", "Strength_rgb_tw").."，持續 "..CNumb("{time:%s}", "time_var_rgb").." 秒。 "
				..CPhrs("Can_be_refr")..CNote("Pwr_note"),
		...
		["loc_trait_bespoke_power_bonus_after_weapon_special_multiple_desc"] = { -- power_level: 15%, time: 5, +colors
			...
			["zh-tw"] = "武器特殊攻擊爆炸命中多名敵人後，獲得 "..CNumb("{power_level:%s}", "pwrlvl_var_rgb").." "..CKWord("威力", "Strength_rgb_tw").."，持續 "..CNumb("{time:%s}", "time_var_rgb").." 秒。 "
				..CPhrs("Can_be_refr")..CNote("Pwr_note"),
		...
		["loc_trait_bespoke_power_bonus_based_on_charge_time_ranged_desc"] = { -- power_level: +8%, time: 0.4, stacks: 5, +colors
			...
			["zh-tw"] = "瞄準時每 "..CNumb("{time:%s}", "time_var_rgb").." 秒獲得 "..CNumb("{power_level:%s}", "pwrlvl_var_rgb").." "..CKWord("威力", "Strength_rgb_tw").."。堆疊 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 次。射擊、推擊或離開副射擊模式時移除所有層數。 "
				..CNote("Pwr_note"),
		...
		["loc_trait_bespoke_ammo_refill_from_reserve_on_crit_desc"] = { -- bullet_amount: +5, +colors
			...
			["zh-tw"] = CKWord("暴擊命中", "Crit_hit_rgb_tw").."時，從備彈裝填 "..CNumb("{bullet_amount:%s}", "blltam_var_rgb").." 發子彈。 "
				..Dot_nc.." 每次"..CKWord("暴擊", "Crit_rgb_tw").."觸發一次；該次射擊不需要命中敵人。",
		...
		["loc_trait_bespoke_power_bonus_on_chained_hits_on_single_target_desc"] = { -- power: +10%, hit: 4, time: 2, stacks: 5, s->seconds, +colors
			...
			["zh-tw"] = "每 "..CNumb("{hit:%s}", "hit_var_rgb").." 次命中單一目標，獲得 "..CNumb("{power:%s}", "pwr_var_rgb").." "..CKWord("威力", "Strength_rgb_tw").."，持續 "..CNumb("{time:%s}", "time_var_rgb").." 秒。堆疊 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 次。\n"
				..CPhrs("Can_be_refr")..CNote("Pwr_note"),
		...
		["loc_trait_bespoke_armor_rending_bayonette_desc"] = { -- rending: 2.5%, stacks: 16, time: 5, max_stacks: 16, s->seconds, +colors
			...
			ru = CNumb("{stacks:%s}", "stacks_var_rgb").." зарядов по "..CNumb("{rending:%s}", "rending_var_rgb").." "..CKWord("хрупкости", "hrupkosti_rgb_ru").." брони применяется к врагу при ударе специальной атакой. Длится "..CNumb("{time:%s}", "time_var_rgb").." секунд. До "..CNumb("40%", "pc_40_rgb").." при "..CNumb("{max_stacks:%s}", "maxstks_var_rgb").." зарядах. "
				..CNote("Brtl_note"),
			fr = "Toucher un ennemi avec l'attaque spéciale lui octroie "..CNumb("{stacks:%s}", "stacks_var_rgb").." cumuls de "..CNumb("{rending:%s}", "rending_var_rgb").." de "..CKWord("Fragilité", "Brittleness_rgb_fr")..". Dure "..CNumb("{time:%s}", "time_var_rgb").." secondes. Pour un maximum de "..CNumb("{max_stacks:%s}", "maxstks_var_rgb").." cumuls, Pour un total de "..CNumb("40%", "pc_40_rgb").."."..CNote("Brtl_note"),
			["zh-tw"] = "武器特殊攻擊命中時，對敵人施加 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 層 "..CNumb("{rending:%s}", "rending_var_rgb").." "..CKWord("脆弱", "Brittleness_rgb_tw").."，持續 "..CNumb("{time:%s}", "time_var_rgb").." 秒。最多 "..CNumb("{max_stacks:%s}", "maxstks_var_rgb").." 層，最高 "..CNumb("40%", "pc_40_rgb").."。\n"
				..CNote("Brtl_note"),
			["zh-cn"] = "特殊攻击命中时，对目标施加 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 层 "..CNumb("{rending:%s}", "rending_var_rgb").." "..CKWord("脆弱", "Brittleness_rgb_zh_cn").."，持续 "..CNumb("{time:%s}", "time_var_rgb").." 秒。\n最多叠加 "..CNumb("{max_stacks:%s}", "maxstks_var_rgb").." 层，最高 "..CNumb("40%", "pc_40_rgb").."。"..CNote("Brtl_note"),
			de = "Ein Treffer mit dem Spezialangriff verleiht dem Ziel "..CNumb("{stacks:%s}", "stacks_var_rgb").." Stapel "..CNumb("{rending:%s}", "rending_var_rgb").." "..CKWord("Sprödigkeit", "Brittleness_rgb_de")..". Hält "..CNumb("{time:%s}", "time_var_rgb").." Sek. Maximal "..CNumb("{max_stacks:%s}", "maxstks_var_rgb").." Stapel, insgesamt bis zu "..CNumb("40%", "pc_40_rgb").."."..CNote("Brtl_note"),
			it = "Colpire un nemico con l'attacco speciale gli infligge "..CNumb("{stacks:%s}", "stacks_var_rgb").." accumuli di "..CNumb("{rending:%s}", "rending_var_rgb").." "..CKWord("Fragilità", "Brittleness_rgb_it")..". Dura "..CNumb("{time:%s}", "time_var_rgb").." sec. Massimo "..CNumb("{max_stacks:%s}", "maxstks_var_rgb").." accumuli, fino al "..CNumb("40%", "pc_40_rgb").."."..CNote("Brtl_note"),
		...
		["loc_trait_bespoke_toughness_on_close_range_kills_desc"] = { -- toughness: +6%, +colors
			...
			["zh-tw"] = "擊殺 "..CNumb("12.5", "n_12_5_rgb").." 公尺內的敵人時，獲得 "..CNumb("{toughness:%s}", "tghns_var_rgb").." "..CKWord("韌性", "Toughness_rgb_tw").."。 "
				..Dot_green.." 每次射擊可觸發多次。",
		...
		["loc_trait_bespoke_shot_power_bonus_after_weapon_special_cleave_desc"] = { -- power_level: +15%, time: 3, +colors
			...
			["zh-tw"] = "武器特殊攻擊"..CKWord("順劈攻擊", "Cleaving_rgb_tw").."多名敵人後，你的遠程攻擊獲得 "..CNumb("{power_level:%s}", "pwrlvl_var_rgb").." "..CKWord("威力", "Strength_rgb_tw").."，持續 "..CNumb("{time:%s}", "time_var_rgb").." 秒。 "
				..CPhrs("Can_be_refr")..CNote("Pwr_note"),
		...
		["loc_trait_bespoke_toughness_on_continuous_fire_alternative_desc"] = { -- toughness: +4%, ammo: 10%, stacks: 5, +colors
			...
			["zh-tw"] = "持續射擊期間每發獲得 "..CNumb("{toughness:%s}", "tghns_var_rgb").." "..CKWord("韌性", "Toughness_rgb_tw").."。堆疊 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 次。",
		...
		["loc_trait_bespoke_weapon_special_power_bonus_after_one_shots_desc"] = { -- power_level: +42%, time: 3.5, s->seconds, +colors
			...
			["zh-tw"] = "遠程攻擊命中 "..CNumb("3", "n_3_rgb")..CNumb("+", "n_plus_rgb").." 名敵人時，獲得 "..CNumb("{power_level:%s}", "pwrlvl_var_rgb").." 近戰"..CKWord("威力", "Strength_rgb_tw").."，持續 "..CNumb("{time:%s}", "time_var_rgb").." 秒。\n"
				..CPhrs("Can_be_refr")..CNote("Pwr_note"),
		...
		["loc_trait_bespoke_close_explosion_applies_bleed_desc"] = { -- stacks: 4, +colors
			...
			["zh-tw"] = "近距離爆炸會對敵人施加 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 層 "..CKWord("流血", "Bleed_rgb_tw").."。 "
				..Dot_nc.." 最高 "..CNumb("16", "n_16_rgb").." 層。\n"..Dot_green.." 可穿透護盾施加。 "..CPhrs("Refr_dur_stappl"),
		...
		["loc_trait_bespoke_explosion_radius_bonus_on_continuous_fire_desc"] = { -- radius: +6%, stacks: 5, +colors
			...
			["zh-tw"] = "持續射擊期間每發獲得 "..CNumb("{radius:%s}", "radius_var_rgb").." 爆炸半徑。堆疊 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 次。",
		...
		["loc_trait_bespoke_grenades_stick_to_monsters_and_damage_desc"] = { -- dmg_vs_ogryn_monster: +15%, +colors
			...
			["zh-tw"] = "對歐格林與巨獸 "..CNumb("{dmg_vs_ogryn_monster:%s}", "dmgvogrmon_var_rgb").." "..CKWord("傷害", "Damage_rgb_tw").."。你的榴彈會黏附在歐格林與巨獸身上。",
		...
		["loc_trait_bespoke_weakspot_projectile_hit_increases_reload_speed_desc"] = { -- reload_speed: +30%, duration: 3, +colors
			...
			["zh-tw"] = "投射物"..CKWord("弱點命中", "Weakspothit_rgb_tw").."時，獲得 "..CNumb("{reload_speed:%s}", "reload_var_rgb").." 換彈速度，持續 "..CNumb("{duration:%s}", "dur_var_rgb").." 秒。 "
				..Dot_red.." 啟用期間不可刷新。",
		...
		["loc_trait_bespoke_arc_has_killing_blow_chance_desc"] = {
			...
			["zh-tw"] = CNumb("{proc_chance:%s}", "procch_var_rgb").." 機率使被 "..CKWord("電弧", "Arc_rgb_tw").."閃電擊中的人類體型敵人立即死亡。立即死亡會阻止其他觸發效果。",
		...
		["loc_trait_bespoke_enhanced_arc_jumps_angle_desc"] = {
			...
			["zh-tw"] = CKWord("電弧", "Arc_rgb_tw").."閃電獲得 "..CNumb("{angle:%s}", "angle_var_rgb").." 跳躍角度、"..CNumb("{radius:%s}", "radius_var_rgb").." 公尺跳躍距離，且可額外跳躍 "..CNumb("{jumps:%s}", "jumps_var_rgb").." 次。",
		...
		["loc_trait_bespoke_staggering_hits_has_chance_to_stun_elites_specials_desc"] = {
			...
			["zh-tw"] = "使精英或專家敵人"..CKWord("踉蹌", "Staggering_rgb_tw").."時，有 "..CNumb("{chance:%s}", "chnc_var_rgb").." 機率"..CKWord("電擊", "Electrocute_rgb_tw").."該敵人。冷卻 "..CNumb("{cooldown:%s}", "cd_var_rgb").." 秒。"..Dot_red.." 推擠不會觸發。",
		...
		["loc_trait_bespoke_elite_kills_grants_stackable_melee_power_desc"] = {
			...
			["zh-tw"] = "擊殺精英或專家時，獲得 "..CNumb("{power_level:%s}", "pwrlvl_var_rgb").." 近戰"..CKWord("威力", "Strength_rgb_tw").."，持續 "..CNumb("{time:%s}", "time_var_rgb").." 秒。可疊加 "..CNumb("{stacks:%s}", "stacks_var_rgb").." 層。"..CPhrs("Can_be_refr_drop_1").." "..CNote("Pwr_note"),
		...
		["loc_trait_bespoke_refund_charge_on_weapon_special_weakspot_kill_desc"] = {
			...
			["zh-tw"] = "以武器特殊攻擊"..CKWord("命中弱點", "Weakspothit_rgb_tw").."並擊殺敵人時，立即恢復 "..CNumb("1", "n_1_rgb").." 次武器特殊攻擊充能。每 "..CNumb("{time:%s}", "time_var_rgb").." 秒只能觸發一次。",
		...
		["loc_trait_bespoke_increased_melee_power_on_weapon_special_follow_up_hits_desc"] = {
			...
			["zh-tw"] = "任意近戰攻擊後，使用武器特殊攻擊並以重攻擊命中任意敵人，可使接下來 "..CNumb("3", "n_3_rgb").." 次近戰攻擊獲得 "..CNumb("{power:%s}", "pwr_var_rgb").." "..CKWord("威力", "Strength_rgb_tw").."。"..Dot_red.." 揮空會消耗已強化的攻擊。",
