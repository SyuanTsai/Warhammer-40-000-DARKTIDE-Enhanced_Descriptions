...
--[+ ++CURIOS - РЕЛИКВИИ - 珍品++ +]--
	...
	--[+ TRAITS - ХАРАКТЕРИСТИКИ - 附加屬性 +]--
		...
		["loc_gadget_cooldown_desc"] = { -- ability_cooldown_modifier: +4%
			...
			["zh-tw"] = CNumb("{ability_cooldown_modifier:%s}", "abil_cd_rgb").." "..CKWord("戰鬥技能冷卻", "Cmbt_abil_rgb_tw").."恢復速度",
		...
		["loc_gadget_revive_speed_desc"] = { -- revive_speed_modifier: +12%
			...
			["zh-tw"] = CNumb("{revive_speed_modifier:%s}", "revive_rgb").." 隊友復活速度",
		...
		["loc_trait_gadget_mission_credits_increase_desc"] = { -- mission_reward_credit_modifier: +10%
			...
			["zh-tw"] = CNumb("{mission_reward_credit_modifier:%s}", "credits_rgb").." 審判庭代幣(錢)",
