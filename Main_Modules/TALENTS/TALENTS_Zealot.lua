...
--[+ +ABILITIES - СПОСОБНОСТИ+ +]--	27.03.2026
	...
	["loc_talent_zealot_2_combat_description_new"] = { -- toughness: 50%, damage: 25%, cooldown: 30, s->seconds, +colors
		...
		["zh-tw"] = "向前衝刺並恢復\uff1a\n"
			...
			.."    "..Dot_nc.." 縮放\uff1a最遠 "..CNumb("21", "n_21_rgb").." 米\u3002",
	},
	...
	["loc_talent_zealot_bolstering_prayer_variant_two_description"] = { -- interval: 0.8, toughness: 45%, flat_toughness: +20, max_toughness: +100, cooldown: 60, s->seconds, +colors
		...
		["zh-tw"] = "揮舞"..CKWord("聖物", "Holy_relic_rgb_tw").."\uff0c每 {interval:%s} 秒釋放 "..CNumb("7", "n_7_rgb").." 次能量脈衝。\n"
			...
			.."\n"
			.."每次脈衝賦予"..CKWord("狂信徒", "cls_zea_rgb_tw").." 和"..CKWord("協同", "Coherency_rgb_tw").." 盟友 "..CNumb("1.5", "n_1_5_rgb").." 秒\uff1a\n"
			..Dot_green.." 無敋狀態 和\n"
			..Dot_green.." 免疫近戰和遠程"..CKWord("眩暈", "Stuns_rgb_tw").."\u3002\n"
			..CPhrs("Can_be_refr").."\n"
			.."\n"
			.."韌性不滿 "..CNumb("100%", "pc_100_rgb").." 時\uff0c恢復\uff1a\n"
			..Dot_green.." "..CNumb("20%", "pc_20_rgb").." "..CKWord("韌性", "Toughness_rgb_tw").." 立即 和\n"
			..Dot_green.." "..CNumb("25%", "pc_25_rgb").." "..CKWord("韌性", "Toughness_rgb_tw").." 在下一秒內\u3002\n"
			.."韌性已滿時\uff0c增加\uff1a\n"
...
--[+ +KEYSTONES - КЛЮЧЕВЫЕ+ +]--
	...
	["loc_talent_zealot_cooldown_on_backstab_weakspot_desc"] = { -- cooldown: +75%, duration: 2, +colors
		...
		["zh-tw"] = Dot_green.." 近戰背刺或弱點命中後 {duration:%s} 秒內，{cooldown:%s} "..CKWord("技能冷卻", "Ability_cd_rgb_tw").." 恢復速度。",
--[+ +PASSIVES - ПАССИВНЫЕ+ +]--
	...
	["loc_talent_zealot_ranged_damage_increased_to_close_desc"] = { -- damage: +25%, +colors
		...
		["zh-tw"] = "最多 {damage:%s} 基礎遠程"..CKWord("傷害", "Damage_rgb_tw").."\uff0c距目標越遠則冇。",
	},
	...
	["loc_talent_zealot_backstab_flanking_damage_all_desc"] = { -- damage: +25%, +colors
		...
		["zh-tw"] = Dot_green.." {damage:%s} 背刺和測翼命中"..CKWord("傷害", "Damage_rgb_tw").."\u3002",
	},
	...
	["loc_talent_zealot_toughness_on_ranged_kill_desc"] = { -- toughness: 4%, +colors
		...
		["zh-tw"] = Dot_green.." {toughness:%s} "..CKWord("韌性", "Toughness_rgb_tw").." 在遠程擊殺時恢復。",
	},
	...
	["loc_talent_zealot_toughness_on_melee_kill_desc"] = { -- toughness: +100%, +colors
		...
		["zh-tw"] = Dot_green.." {toughness:%s} 近戰擊殺時"..CKWord("韌性", "Toughness_rgb_tw").." 恢復。",
	},
	...
	["loc_talent_zealot_toughness_on_dodge_desc"] = { -- toughness: 15%, +colors
		...
		["zh-tw"] = Dot_green.." {toughness:%s} "..CKWord("韌性", "Toughness_rgb_tw").." 成功閃避時恢復。",
	},
	...
	["loc_talent_zealot_toughness_on_heavy_kills_desc"] = { -- toughness: 10%, +colors
		...
		["zh-tw"] = Dot_green.." {toughness:%s} "..CKWord("韌性", "Toughness_rgb_tw").." 重攻擊殺時恢復。",
	},
	...
	["loc_talent_zealot_increased_stagger_on_weakspot_melee_description"] = { -- impact_modifier: +50%, +colors
		...
		["zh-tw"] = Dot_green.." 近戰"..CKWord("弱點", "Weakspot_rgb_tw").." 命中 {impact_modifier:%s} "..CKWord("踉蹌", "Stagger_rgb_tw").."\u3002",
	},
	...
	["loc_talent_zealot_toughness_melee_effectiveness_desc"] = { -- toughness_damage_reduction: +50%, time: 4, s->seconds, +colors
		...
		["zh-tw"] = Dot_green.." "..CKWord("暴擊", "Crit_hit_rgb_tw").." 時 {time:%s} 秒內，{toughness_damage_reduction:%s} "..CKWord("韌性傷害減免", "Tghns_dmg_red_rgb_tw").."\u3002",
	},
	...
	["loc_talent_zealot_3_tier_3_ability_2_description"] = { -- damage_reduction: 40%, +colors
		...
		["zh-tw"] = Dot_green.." "..CNumb("-", "n_minus_rgb").." {damage_reduction:%s} 將你"..CKWord("生命", "Health_rgb_tw").." 減至下一個"..CKWord("傷痕", "Wound_rgb_tw").." 的"..CKWord("傷害", "Damage_rgb_tw").."\u3002",
	},
	...
	["loc_talent_zealot_weakspot_damage_reduction_desc"] = { -- damage_resistance: +15%, duration: 4, +colors
		...
		ru = Dot_green.." {damage_resistance:%s} к сопротивлению "..CKWord("урону", "uronu_rgb_ru").." после убийства в "..CKWord("уязвимое место", "ujazvimoe_mesto_rgb_ru")..".\n" -- руоф Гордыня
			..Dot_nc.." Длится: {duration:%s} секунд.",
		["zh-tw"] = Dot_green.." "..CKWord("弱點", "Weakspot_rgb_tw").." 擊殺後 {duration:%s} 秒內，{damage_resistance:%s} 傷害抗性。",
	},
	...
	["loc_talent_zealot_uninterruptible_no_slow_heavies_desc"] = {
		...
		["zh-tw"] = Dot_green.." 近戰攻擊潜行期間獲得不可中斷狀態\u3002\n"
			.."\n"
